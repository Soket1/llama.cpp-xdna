...
8:                                                ; preds = %5
  ...
  call void @layer_fused_qkv_bcast_bf16(i32 %9, i32 0, ptr @c1_A0, ptr @c1_B0, ptr @c1_Q)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %10 = add i64 %6, 1
  %11 = trunc i64 %10 to i32
  call void @layer_fused_qkv_bcast_bf16(i32 %11, i32 0, ptr @c1_A1, ptr @c1_B0, ptr @c1_Q)
...
17:                                               ; preds = %14
  ...
  call void @layer_fused_oproj_bcast_bf16(i32 %18, i32 0, ptr @c1_A0, ptr @c1_B1, ptr @c1_O)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %19 = add i64 %15, 1
  %20 = trunc i64 %19 to i32
  call void @layer_fused_oproj_bcast_bf16(i32 %20, i32 0, ptr @c1_A1, ptr @c1_B1, ptr @c1_O)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %21 = add i64 %15, 2
  br label %14
...
26:                                               ; preds = %23
  ...
  call void @layer_fused_gate_up_bcast_bf16(i32 %27, i32 0, ptr @c1_A0, ptr @c1_B2, i32 0)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %28 = add i64 %24, 1
  %29 = trunc i64 %28 to i32
  call void @layer_fused_gate_up_bcast_bf16(i32 %29, i32 0, ptr @c1_A1, ptr @c1_B2, i32 0)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %30 = add i64 %24, 2
  br label %23
...
34:                                               ; preds = %31
  ...
  call void @layer_fused_gate_up_bcast_bf16(i32 %35, i32 1, ptr @c1_A0, ptr @c1_B2, i32 1)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %36 = add i64 %32, 1
  %37 = trunc i64 %36 to i32
  call void @layer_fused_gate_up_bcast_bf16(i32 %37, i32 1, ptr @c1_A1, ptr @c1_B2, i32 1)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %38 = add i64 %32, 2
  br label %31
...
43:                                               ; preds = %40
  ...
  call void @layer_fused_down_bcast_bf16(i32 %44, i32 0, ptr @c1_A0, ptr @c1_P)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %45 = add i64 %41, 1
  %46 = trunc i64 %45 to i32
  call void @layer_fused_down_bcast_bf16(i32 %46, i32 0, ptr @c1_A1, ptr @c1_P)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %47 = add i64 %41, 2
  br label %40
