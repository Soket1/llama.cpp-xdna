module {
  aie.device(npu2) {
    ...
    aie.flow(%sh0, DMA : 0, %t0, DMA : 0)   // A0
    ...
    aie.flow(%sh1, DMA : 0, %t1, DMA : 0)   // A1
    ...
    aie.flow(%sh6, DMA : 0, %t6, DMA : 0)   // A6
    ...
    aie.flow(%sh7, DMA : 0, %t7, DMA : 0)   // A7
    ...
    %core0 = aie.core(%t0) {
      ...
      scf.for %tok = %c0 to %cN step %c1 {
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          ...
          func.call @layer_fused_qkv_bcast_bf16(%ji0, %g0, %c0_A0, %c0_B0, %c0_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
          ...
          func.call @layer_fused_qkv_bcast_bf16(%ji1, %g0, %c0_A1, %c0_B0, %c0_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          aie.use_lock(%c0_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji0, %g0, %c0_A0, %c0_B1, %c0_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c0_A0p, Release, 1)
          aie.use_lock(%c0_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji1, %g0, %c0_A1, %c0_B1, %c0_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c0_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g0, %c0_A0, %c0_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c0_A0p, Release, 1)
          aie.use_lock(%c0_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g0, %c0_A1, %c0_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c0_A1p, Release, 1)
        }
        scf.for %j = %c0 to %cF step %c2 {
          aie.use_lock(%c0_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g1, %c0_A0, %c0_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c0_A0p, Release, 1)
          aie.use_lock(%c0_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g1, %c0_A1, %c0_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c0_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          func.call @layer_fused_down_bcast_bf16(%ji0, %g0, %c0_A0, %c0_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c0_A0p, Release, 1)
          aie.use_lock(%c0_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji1, %g0, %c0_A1, %c0_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c0_A1p, Release, 1)
        }
    ...
    %core1 = aie.core(%t1) {
      ...
      scf.for %tok = %c0 to %cN step %c1 {
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji0, %g0, %c1_A0, %c1_B0, %c1_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
          aie.use_lock(%c1_A0p, Release, 1)
          aie.use_lock(%c1_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji1, %g0, %c1_A1, %c1_B0, %c1_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          aie.use_lock(%c1_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji0, %g0, %c1_A0, %c1_B1, %c1_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c1_A0p, Release, 1)
          aie.use_lock(%c1_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji1, %g0, %c1_A1, %c1_B1, %c1_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c1_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g0, %c1_A0, %c1_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c1_A0p, Release, 1)
          aie.use_lock(%c1_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g0, %c1_A1, %c1_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c1_A1p, Release, 1)
        }
        scf.for %j = %c0 to %cF step %c2 {
          aie.use_lock(%c1_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g1, %c1_A0, %c1_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c1_A0p, Release, 1)
          aie.use_lock(%c1_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g1, %c1_A1, %c1_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c1_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji0, %g0, %c1_A0, %c1_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c1_A0p, Release, 1)
          aie.use_lock(%c1_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji1, %g0, %c1_A1, %c1_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c1_A1p, Release, 1)
        }
    ...
    %core2 = aie.core(%t2) {
      ...
      scf.for %tok = %c0 to %cN step %c1 {
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji0, %g0, %c2_A0, %c2_B0, %c2_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
          aie.use_lock(%c2_A0p, Release, 1)
          aie.use_lock(%c2_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji1, %g0, %c2_A1, %c2_B0, %c2_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          aie.use_lock(%c2_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji0, %g0, %c2_A0, %c2_B1, %c2_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c2_A0p, Release, 1)
          aie.use_lock(%c2_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji1, %g0, %c2_A1, %c2_B1, %c2_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c2_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g0, %c2_A0, %c2_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c2_A0p, Release, 1)
          aie.use_lock(%c2_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g0, %c2_A1, %c2_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c2_A1p, Release, 1)
        }
        scf.for %j = %c0 to %cF step %c2 {
          aie.use_lock(%c2_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g1, %c2_A0, %c2_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c2_A0p, Release, 1)
          aie.use_lock(%c2_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g1, %c2_A1, %c2_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c2_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji0, %g0, %c2_A0, %c2_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c2_A0p, Release, 1)
          aie.use_lock(%c2_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji1, %g0, %c2_A1, %c2_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c2_A1p, Release, 1)
        }
    ...
    %core3 = aie.core(%t3) {
      ...
      scf.for %tok = %c0 to %cN step %c1 {
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji0, %g0, %c3_A0, %c3_B0, %c3_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
          aie.use_lock(%c3_A0p, Release, 1)
          aie.use_lock(%c3_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji1, %g0, %c3_A1, %c3_B0, %c3_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          aie.use_lock(%c3_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji0, %g0, %c3_A0, %c3_B1, %c3_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c3_A0p, Release, 1)
          aie.use_lock(%c3_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji1, %g0, %c3_A1, %c3_B1, %c3_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c3_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g0, %c3_A0, %c3_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c3_A0p, Release, 1)
          aie.use_lock(%c3_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g0, %c3_A1, %c3_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c3_A1p, Release, 1)
        }
        scf.for %j = %c0 to %cF step %c2 {
          aie.use_lock(%c3_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g1, %c3_A0, %c3_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c3_A0p, Release, 1)
          aie.use_lock(%c3_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g1, %c3_A1, %c3_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c3_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji0, %g0, %c3_A0, %c3_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c3_A0p, Release, 1)
          aie.use_lock(%c3_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji1, %g0, %c3_A1, %c3_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c3_A1p, Release, 1)
        }
    ...
    %core4 = aie.core(%t4) {
      ...
      scf.for %tok = %c0 to %cN step %c1 {
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji0, %g0, %c4_A0, %c4_B0, %c4_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
          aie.use_lock(%c4_A0p, Release, 1)
          aie.use_lock(%c4_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji1, %g0, %c4_A1, %c4_B0, %c4_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          aie.use_lock(%c4_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji0, %g0, %c4_A0, %c4_B1, %c4_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c4_A0p, Release, 1)
          aie.use_lock(%c4_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji1, %g0, %c4_A1, %c4_B1, %c4_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c4_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g0, %c4_A0, %c4_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c4_A0p, Release, 1)
          aie.use_lock(%c4_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g0, %c4_A1, %c4_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c4_A1p, Release, 1)
        }
        scf.for %j = %c0 to %cF step %c2 {
          aie.use_lock(%c4_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g1, %c4_A0, %c4_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c4_A0p, Release, 1)
          aie.use_lock(%c4_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g1, %c4_A1, %c4_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c4_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji0, %g0, %c4_A0, %c4_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c4_A0p, Release, 1)
          aie.use_lock(%c4_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji1, %g0, %c4_A1, %c4_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c4_A1p, Release, 1)
        }
    ...
    %core5 = aie.core(%t5) {
      ...
      scf.for %tok = %c0 to %cN step %c1 {
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji0, %g0, %c5_A0, %c5_B0, %c5_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
          aie.use_lock(%c5_A0p, Release, 1)
          aie.use_lock(%c5_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji1, %g0, %c5_A1, %c5_B0, %c5_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          aie.use_lock(%c5_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji0, %g0, %c5_A0, %c5_B1, %c5_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c5_A0p, Release, 1)
          aie.use_lock(%c5_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji1, %g0, %c5_A1, %c5_B1, %c5_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c5_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g0, %c5_A0, %c5_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c5_A0p, Release, 1)
          aie.use_lock(%c5_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g0, %c5_A1, %c5_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c5_A1p, Release, 1)
        }
        scf.for %j = %c0 to %cF step %c2 {
          aie.use_lock(%c5_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g1, %c5_A0, %c5_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c5_A0p, Release, 1)
          aie.use_lock(%c5_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g1, %c5_A1, %c5_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c5_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji0, %g0, %c5_A0, %c5_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c5_A0p, Release, 1)
          aie.use_lock(%c5_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji1, %g0, %c5_A1, %c5_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c5_A1p, Release, 1)
        }
    ...
    %core6 = aie.core(%t6) {
      ...
      scf.for %tok = %c0 to %cN step %c1 {
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji0, %g0, %c6_A0, %c6_B0, %c6_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
          aie.use_lock(%c6_A0p, Release, 1)
          aie.use_lock(%c6_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji1, %g0, %c6_A1, %c6_B0, %c6_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          aie.use_lock(%c6_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji0, %g0, %c6_A0, %c6_B1, %c6_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c6_A0p, Release, 1)
          aie.use_lock(%c6_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji1, %g0, %c6_A1, %c6_B1, %c6_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c6_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g0, %c6_A0, %c6_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c6_A0p, Release, 1)
          aie.use_lock(%c6_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g0, %c6_A1, %c6_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c6_A1p, Release, 1)
        }
        scf.for %j = %c0 to %cF step %c2 {
          aie.use_lock(%c6_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g1, %c6_A0, %c6_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c6_A0p, Release, 1)
          aie.use_lock(%c6_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g1, %c6_A1, %c6_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c6_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji0, %g0, %c6_A0, %c6_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c6_A0p, Release, 1)
          aie.use_lock(%c6_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji1, %g0, %c6_A1, %c6_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c6_A1p, Release, 1)
        }
    ...
    %core7 = aie.core(%t7) {
      ...
      scf.for %tok = %c0 to %cN step %c1 {
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji0, %g0, %c7_A0, %c7_B0, %c7_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
          aie.use_lock(%c7_A0p, Release, 1)
          aie.use_lock(%c7_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_qkv_bcast_bf16(%ji1, %g0, %c7_A1, %c7_B0, %c7_Q) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<322xbf16>) -> ()
        ...
        scf.for %j = %c0 to %c64 step %c2 {
          aie.use_lock(%c7_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji0, %g0, %c7_A0, %c7_B1, %c7_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c7_A0p, Release, 1)
          aie.use_lock(%c7_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          func.call @layer_fused_oproj_bcast_bf16(%ji1, %g0, %c7_A1, %c7_B1, %c7_O) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, memref<2048xbf16>) -> ()
          aie.use_lock(%c7_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g0, %c7_A0, %c7_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c7_A0p, Release, 1)
          aie.use_lock(%c7_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g0, %c7_A1, %c7_B2, %g0) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c7_A1p, Release, 1)
        }
        scf.for %j = %c0 to %cF step %c2 {
          aie.use_lock(%c7_A0c, AcquireGreaterEqual, 1)
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji0, %g1, %c7_A0, %c7_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c7_A0p, Release, 1)
          aie.use_lock(%c7_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %m4 : i32
          func.call @layer_fused_gate_up_bcast_bf16(%ji1, %g1, %c7_A1, %c7_B2, %g1) : (i32, i32, memref<4608xi8>, memref<2320xbf16>, i32) -> ()
          aie.use_lock(%c7_A1p, Release, 1)
        }
        ...
        scf.for %j = %c0 to %cF step %c2 {
          ...
          %ji0 = arith.index_cast %j : index to i32
          %ro0 = arith.muli %ji0, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji0, %g0, %c7_A0, %c7_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c7_A0p, Release, 1)
          aie.use_lock(%c7_A1c, AcquireGreaterEqual, 1)
          %j1 = arith.addi %j, %c1 : index
          %ji1 = arith.index_cast %j1 : index to i32
          %ro1 = arith.muli %ji1, %ds : i32
          func.call @layer_fused_down_bcast_bf16(%ji1, %g0, %c7_A1, %c7_P) : (i32, i32, memref<4608xi8>, memref<2320xbf16>) -> ()
          aie.use_lock(%c7_A1p, Release, 1)
        }
    ...
    %Klo_dma = aie.memtile_dma(%Klo) {
      %s0 = aie.dma_start(S2MM, 0, ^Klof0, ^Klom0)
    ^Klof0:
    ...
    ^Kloo2:
      ...
      aie.next_bd ^Kloo2
    ^Klom3:
      %m3 = aie.dma_start(MM2S, 3, ^Kloo3, ^Kloe)
    ^Kloo3:
    ...
    %Khi_dma = aie.memtile_dma(%Khi) {
      %s0 = aie.dma_start(S2MM, 0, ^Khif0, ^Khim0)
    ^Khif0:
    ...
    ^Khio2:
      ...
      aie.next_bd ^Khio2
    ^Khim3:
      %m3 = aie.dma_start(MM2S, 3, ^Khio3, ^Khie)
    ^Khio3:
    ...
    %Vlo_dma = aie.memtile_dma(%Vlo) {
      %s0 = aie.dma_start(S2MM, 0, ^Vlof0, ^Vlom0)
    ^Vlof0:
    ...
    ^Vloo2:
      ...
      aie.next_bd ^Vloo2
    ^Vlom3:
      %m3 = aie.dma_start(MM2S, 3, ^Vloo3, ^Vloe)
    ^Vloo3:
    ...
    %Vhi_dma = aie.memtile_dma(%Vhi) {
      %s0 = aie.dma_start(S2MM, 0, ^Vhif0, ^Vhim0)
    ^Vhif0:
    ...
    ^Vhio2:
      ...
      aie.next_bd ^Vhio2
    ^Vhim3:
      %m3 = aie.dma_start(MM2S, 3, ^Vhio3, ^Vhie)
    ^Vhio3:
