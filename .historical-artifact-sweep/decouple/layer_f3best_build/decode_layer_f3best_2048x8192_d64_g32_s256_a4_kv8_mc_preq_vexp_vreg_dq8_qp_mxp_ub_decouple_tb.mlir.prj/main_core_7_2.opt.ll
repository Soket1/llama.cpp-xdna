; ModuleID = 'decode_layer_f3best_2048x8192_d64_g32_s256_a4_kv8_mc_preq_vexp_vreg_dq8_qp_mxp_ub_decouple_tb.mlir.prj\main_core_7_2.peanohack.ll'
...
1:                                                ; preds = %0, %1
  ...
  tail call void @flowkv_score_rope_q_bf16(ptr nonnull @sc3_Qs, i32 4, i32 64)
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  tail call void @flowkv_score_chunk_bf16(ptr nonnull @sc3_Qs, ptr nonnull @sc3_K, ptr nonnull @sc3_It, i32 4, i32 64, i32 128)
