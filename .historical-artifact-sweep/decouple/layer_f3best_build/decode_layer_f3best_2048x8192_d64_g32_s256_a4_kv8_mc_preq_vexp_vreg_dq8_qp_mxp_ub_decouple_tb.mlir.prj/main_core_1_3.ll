...
4:                                                ; preds = %1
  call void @flowkv_score_init_bf16(i32 4)
  call void @llvm.aie2p.acquire(i32 49, i32 -1)
  call void @flowkv_score_rope_q_bf16(ptr @sc5_Qs, i32 4, i32 64)
  br label %5
...
8:                                                ; preds = %5
  ...
  call void @flowkv_score_chunk_bf16(ptr @sc5_Qs, ptr @sc5_K, ptr @sc5_It, i32 4, i32 64, i32 128)
