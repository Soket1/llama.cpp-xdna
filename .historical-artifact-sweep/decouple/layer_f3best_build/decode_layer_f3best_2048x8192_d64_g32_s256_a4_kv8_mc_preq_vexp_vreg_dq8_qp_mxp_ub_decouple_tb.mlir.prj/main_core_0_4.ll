...
4:                                                ; preds = %1
  call void @flowkv_value_init_bf16(i32 4, i32 64)
  br label %5
...
8:                                                ; preds = %5
  ...
  call void @flowkv_value_accum_bf16(ptr @va0_Iv, ptr @va0_V, i32 4, i32 64, i32 128)
...
10:                                               ; preds = %5
  ...
  call void @flowkv_value_normalize_bf16(ptr @va0_Of, i32 4, i32 64)
