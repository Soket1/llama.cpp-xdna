module {
  aie.device(npu2) {
    ...
    aie.flow(%mem_tile_0_1, DMA : 4, %tile_2_2, DMA : 0)
    ...
    aie.flow(%shim_noc_tile_1_0, DMA : 0, %mem_tile_1_1, DMA : 4)
    aie.flow(%mem_tile_1_1, DMA : 4, %tile_3_2, DMA : 0)
    ...
    aie.flow(%mem_tile_6_1, DMA : 4, %tile_4_3, DMA : 0)
    ...
    aie.flow(%shim_noc_tile_7_0, DMA : 0, %mem_tile_7_1, DMA : 4)
    aie.flow(%mem_tile_7_1, DMA : 4, %tile_5_3, DMA : 0)
    ...
    %Klo_wt = aie.buffer(%mem_tile_0_1) {address = 131072 : i32, sym_name = "Klo_wt"} : memref<9216xi8> 
    %Klo_wsp0 = aie.lock(%mem_tile_0_1, 8) {init = 1 : i32, sym_name = "Klo_wsp0"}
    %Klo_wsc0 = aie.lock(%mem_tile_0_1, 9) {init = 0 : i32, sym_name = "Klo_wsc0"}
    %Klo_wsp1 = aie.lock(%mem_tile_0_1, 10) {init = 1 : i32, sym_name = "Klo_wsp1"}
    %Klo_wsc1 = aie.lock(%mem_tile_0_1, 11) {init = 0 : i32, sym_name = "Klo_wsc1"}
    ...
    ^bb4:  // pred: ^bb3
      ...
      aie.next_bd ^bb1
    ^bb5:  // pred: ^bb0
      %1 = aie.dma_start(S2MM, 4, ^bb6, ^bb8)
    ^bb6:  // 2 preds: ^bb5, ^bb7
      aie.use_lock(%Klo_wsp0, AcquireGreaterEqual, 1)
      aie.dma_bd(%Klo_wt : memref<9216xi8>, 0, 4608) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%Klo_wsc0, Release, 1)
      aie.next_bd ^bb7
    ^bb7:  // pred: ^bb6
      aie.use_lock(%Klo_wsp1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Klo_wt : memref<9216xi8>, 4608, 4608) {bd_id = 5 : i32, next_bd_id = 4 : i32}
      aie.use_lock(%Klo_wsc1, Release, 1)
      aie.next_bd ^bb6
    ^bb8:  // pred: ^bb5
      %2 = aie.dma_start(MM2S, 0, ^bb9, ^bb10)
    ^bb9:  // 2 preds: ^bb8, ^bb9
      aie.use_lock(%Klo_c0, AcquireGreaterEqual, 1)
      aie.dma_bd(%Klo_buf : memref<65536xbf16>, 0, 16384) {bd_id = 6 : i32, next_bd_id = 6 : i32}
      aie.use_lock(%Klo_p0, Release, 1)
      aie.next_bd ^bb9
    ^bb10:  // pred: ^bb8
      %3 = aie.dma_start(MM2S, 1, ^bb11, ^bb12)
    ^bb11:  // 2 preds: ^bb10, ^bb11
      ...
      aie.next_bd ^bb11
    ^bb12:  // pred: ^bb10
      %4 = aie.dma_start(MM2S, 2, ^bb13, ^bb14)
    ^bb13:  // 2 preds: ^bb12, ^bb13
      aie.use_lock(%Klo_c2, AcquireGreaterEqual, 1)
      aie.dma_bd(%Klo_buf : memref<65536xbf16>, 32768, 16384) {bd_id = 7 : i32, next_bd_id = 7 : i32}
      aie.use_lock(%Klo_p2, Release, 1)
      aie.next_bd ^bb13
    ^bb14:  // pred: ^bb12
      %5 = aie.dma_start(MM2S, 3, ^bb15, ^bb16)
    ^bb15:  // 2 preds: ^bb14, ^bb15
      ...
      aie.next_bd ^bb15
    ^bb16:  // pred: ^bb14
      %6 = aie.dma_start(MM2S, 4, ^bb17, ^bb19)
    ^bb17:  // 2 preds: ^bb16, ^bb18
      aie.use_lock(%Klo_wsc0, AcquireGreaterEqual, 1)
      aie.dma_bd(%Klo_wt : memref<9216xi8>, 0, 4608) {bd_id = 8 : i32, next_bd_id = 9 : i32}
      aie.use_lock(%Klo_wsp0, Release, 1)
      aie.next_bd ^bb18
    ^bb18:  // pred: ^bb17
      aie.use_lock(%Klo_wsc1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Klo_wt : memref<9216xi8>, 4608, 4608) {bd_id = 9 : i32, next_bd_id = 8 : i32}
    ...
    %Khi_wt = aie.buffer(%mem_tile_1_1) {address = 131072 : i32, sym_name = "Khi_wt"} : memref<9216xi8> 
    %Khi_wsp0 = aie.lock(%mem_tile_1_1, 8) {init = 1 : i32, sym_name = "Khi_wsp0"}
    %Khi_wsc0 = aie.lock(%mem_tile_1_1, 9) {init = 0 : i32, sym_name = "Khi_wsc0"}
    %Khi_wsp1 = aie.lock(%mem_tile_1_1, 10) {init = 1 : i32, sym_name = "Khi_wsp1"}
    %Khi_wsc1 = aie.lock(%mem_tile_1_1, 11) {init = 0 : i32, sym_name = "Khi_wsc1"}
    ...
    ^bb6:  // 2 preds: ^bb5, ^bb7
      ...
      aie.dma_bd(%Khi_wt : memref<9216xi8>, 0, 4608) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%Khi_wsc0, Release, 1)
      aie.next_bd ^bb7
    ^bb7:  // pred: ^bb6
      aie.use_lock(%Khi_wsp1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Khi_wt : memref<9216xi8>, 4608, 4608) {bd_id = 5 : i32, next_bd_id = 4 : i32}
    ...
    ^bb9:  // 2 preds: ^bb8, ^bb9
      ...
      aie.dma_bd(%Khi_buf : memref<65536xbf16>, 0, 16384) {bd_id = 6 : i32, next_bd_id = 6 : i32}
    ...
    ^bb13:  // 2 preds: ^bb12, ^bb13
      ...
      aie.dma_bd(%Khi_buf : memref<65536xbf16>, 32768, 16384) {bd_id = 7 : i32, next_bd_id = 7 : i32}
    ...
    ^bb17:  // 2 preds: ^bb16, ^bb18
      ...
      aie.dma_bd(%Khi_wt : memref<9216xi8>, 0, 4608) {bd_id = 8 : i32, next_bd_id = 9 : i32}
      aie.use_lock(%Khi_wsp0, Release, 1)
      aie.next_bd ^bb18
    ^bb18:  // pred: ^bb17
      aie.use_lock(%Khi_wsc1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Khi_wt : memref<9216xi8>, 4608, 4608) {bd_id = 9 : i32, next_bd_id = 8 : i32}
    ...
    %Vlo_wt = aie.buffer(%mem_tile_6_1) {address = 131072 : i32, sym_name = "Vlo_wt"} : memref<9216xi8> 
    %Vlo_wsp0 = aie.lock(%mem_tile_6_1, 8) {init = 1 : i32, sym_name = "Vlo_wsp0"}
    %Vlo_wsc0 = aie.lock(%mem_tile_6_1, 9) {init = 0 : i32, sym_name = "Vlo_wsc0"}
    %Vlo_wsp1 = aie.lock(%mem_tile_6_1, 10) {init = 1 : i32, sym_name = "Vlo_wsp1"}
    %Vlo_wsc1 = aie.lock(%mem_tile_6_1, 11) {init = 0 : i32, sym_name = "Vlo_wsc1"}
    ...
    ^bb6:  // 2 preds: ^bb5, ^bb7
      ...
      aie.dma_bd(%Vlo_wt : memref<9216xi8>, 0, 4608) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%Vlo_wsc0, Release, 1)
      aie.next_bd ^bb7
    ^bb7:  // pred: ^bb6
      aie.use_lock(%Vlo_wsp1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Vlo_wt : memref<9216xi8>, 4608, 4608) {bd_id = 5 : i32, next_bd_id = 4 : i32}
    ...
    ^bb9:  // 2 preds: ^bb8, ^bb9
      ...
      aie.dma_bd(%Vlo_buf : memref<65536xbf16>, 0, 16384) {bd_id = 6 : i32, next_bd_id = 6 : i32}
    ...
    ^bb13:  // 2 preds: ^bb12, ^bb13
      ...
      aie.dma_bd(%Vlo_buf : memref<65536xbf16>, 32768, 16384) {bd_id = 7 : i32, next_bd_id = 7 : i32}
    ...
    ^bb17:  // 2 preds: ^bb16, ^bb18
      ...
      aie.dma_bd(%Vlo_wt : memref<9216xi8>, 0, 4608) {bd_id = 8 : i32, next_bd_id = 9 : i32}
      aie.use_lock(%Vlo_wsp0, Release, 1)
      aie.next_bd ^bb18
    ^bb18:  // pred: ^bb17
      aie.use_lock(%Vlo_wsc1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Vlo_wt : memref<9216xi8>, 4608, 4608) {bd_id = 9 : i32, next_bd_id = 8 : i32}
    ...
    %Vhi_wt = aie.buffer(%mem_tile_7_1) {address = 131072 : i32, sym_name = "Vhi_wt"} : memref<9216xi8> 
    %Vhi_wsp0 = aie.lock(%mem_tile_7_1, 8) {init = 1 : i32, sym_name = "Vhi_wsp0"}
    %Vhi_wsc0 = aie.lock(%mem_tile_7_1, 9) {init = 0 : i32, sym_name = "Vhi_wsc0"}
    %Vhi_wsp1 = aie.lock(%mem_tile_7_1, 10) {init = 1 : i32, sym_name = "Vhi_wsp1"}
    %Vhi_wsc1 = aie.lock(%mem_tile_7_1, 11) {init = 0 : i32, sym_name = "Vhi_wsc1"}
    ...
    ^bb6:  // 2 preds: ^bb5, ^bb7
      ...
      aie.dma_bd(%Vhi_wt : memref<9216xi8>, 0, 4608) {bd_id = 4 : i32, next_bd_id = 5 : i32}
      aie.use_lock(%Vhi_wsc0, Release, 1)
      aie.next_bd ^bb7
    ^bb7:  // pred: ^bb6
      aie.use_lock(%Vhi_wsp1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Vhi_wt : memref<9216xi8>, 4608, 4608) {bd_id = 5 : i32, next_bd_id = 4 : i32}
    ...
    ^bb9:  // 2 preds: ^bb8, ^bb9
      ...
      aie.dma_bd(%Vhi_buf : memref<65536xbf16>, 0, 16384) {bd_id = 6 : i32, next_bd_id = 6 : i32}
    ...
    ^bb13:  // 2 preds: ^bb12, ^bb13
      ...
      aie.dma_bd(%Vhi_buf : memref<65536xbf16>, 32768, 16384) {bd_id = 7 : i32, next_bd_id = 7 : i32}
    ...
    ^bb17:  // 2 preds: ^bb16, ^bb18
      ...
      aie.dma_bd(%Vhi_wt : memref<9216xi8>, 0, 4608) {bd_id = 8 : i32, next_bd_id = 9 : i32}
      aie.use_lock(%Vhi_wsp0, Release, 1)
      aie.next_bd ^bb18
    ^bb18:  // pred: ^bb17
      aie.use_lock(%Vhi_wsc1, AcquireGreaterEqual, 1)
      aie.dma_bd(%Vhi_wt : memref<9216xi8>, 4608, 4608) {bd_id = 9 : i32, next_bd_id = 8 : i32}
