...
8:                                                ; preds = %5
  ...
  call void @generic_bcast_gemv_bf16_q(i32 %9, ptr @c1_A0, ptr @c1_B0, ptr @c1_uni_partial, i32 8, ptr @c1_Q)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %10 = add i64 %6, 1
  %11 = trunc i64 %10 to i32
  call void @generic_bcast_gemv_bf16_q(i32 %11, ptr @c1_A1, ptr @c1_B0, ptr @c1_uni_partial, i32 8, ptr @c1_Q)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %12 = add i64 %6, 2
  br label %5

13:                                               ; preds = %5
  call void @rope_bundled(ptr @c1_Q, ptr @c1_B0, ptr @c1_Q, i32 256)
...
17:                                               ; preds = %14
  ...
  call void @generic_bcast_gemv_bf16_o(i32 %18, ptr @c1_A0, ptr @c1_B1, ptr @c1_uni_partial, i32 8, ptr @c1_O)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %19 = add i64 %15, 1
  %20 = trunc i64 %19 to i32
  call void @generic_bcast_gemv_bf16_o(i32 %20, ptr @c1_A1, ptr @c1_B1, ptr @c1_uni_partial, i32 8, ptr @c1_O)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %21 = add i64 %15, 2
  br label %14
...
26:                                               ; preds = %23
  ...
  call void @generic_bcast_gemv_bf16_g(i32 %27, ptr @c1_A0, ptr @c1_B2, ptr @c1_uni_partial, i32 8, ptr @c1_gate)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %28 = add i64 %24, 1
  %29 = trunc i64 %28 to i32
  call void @generic_bcast_gemv_bf16_g(i32 %29, ptr @c1_A1, ptr @c1_B2, ptr @c1_uni_partial, i32 8, ptr @c1_gate)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %30 = add i64 %24, 2
  br label %23
...
34:                                               ; preds = %31
  ...
  call void @generic_bcast_gemv_bf16_g(i32 %35, ptr @c1_A0, ptr @c1_B2, ptr @c1_uni_partial, i32 8, ptr @c1_up)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %36 = add i64 %32, 1
  %37 = trunc i64 %36 to i32
  call void @generic_bcast_gemv_bf16_g(i32 %37, ptr @c1_A1, ptr @c1_B2, ptr @c1_uni_partial, i32 8, ptr @c1_up)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %38 = add i64 %32, 2
  br label %31
...
39:                                               ; preds = %31
  ...
  call void @layer_fused_silu_mul_explicit_bf16(ptr @c1_gate, ptr @c1_up, ptr @c1_silu, i32 1024)
...
43:                                               ; preds = %40
  ...
  call void @generic_bcast_gemv_bf16_d(i32 %44, ptr @c1_A0, ptr @c1_silu, ptr @c1_uni_partial, i32 4, ptr @c1_P)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %45 = add i64 %41, 1
  %46 = trunc i64 %45 to i32
  call void @generic_bcast_gemv_bf16_d(i32 %46, ptr @c1_A1, ptr @c1_silu, ptr @c1_uni_partial, i32 4, ptr @c1_P)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %47 = add i64 %41, 2
  br label %40
