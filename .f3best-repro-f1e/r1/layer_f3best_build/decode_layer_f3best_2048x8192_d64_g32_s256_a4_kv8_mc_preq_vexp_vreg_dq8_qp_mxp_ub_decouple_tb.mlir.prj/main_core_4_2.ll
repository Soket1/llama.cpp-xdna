...
@Vhi_wt = external global [9216 x i8]
@Vhi_buf = external global [65536 x bfloat]
@Vlo_wt = external global [9216 x i8]
@Vlo_buf = external global [65536 x bfloat]
@Khi_wt = external global [9216 x i8]
@Khi_buf = external global [65536 x bfloat]
@Klo_wt = external global [9216 x i8]
...
declare void @generic_bcast_gemv_bf16_q(i32, ptr, ptr, ptr, i32, ptr)

declare void @generic_bcast_gemv_bf16_o(i32, ptr, ptr, ptr, i32, ptr)

declare void @generic_bcast_gemv_bf16_g(i32, ptr, ptr, ptr, i32, ptr)

declare void @generic_bcast_gemv_bf16_d(i32, ptr, ptr, ptr, i32, ptr)

declare void @layer_fused_silu_mul_explicit_bf16(ptr, ptr, ptr, i32)
...
8:                                                ; preds = %5
  ...
  call void @generic_bcast_gemv_bf16_q(i32 %9, ptr @c2_A0, ptr @c2_B0, ptr @c2_uni_partial, i32 8, ptr @c2_Q)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %10 = add i64 %6, 1
  %11 = trunc i64 %10 to i32
  call void @generic_bcast_gemv_bf16_q(i32 %11, ptr @c2_A1, ptr @c2_B0, ptr @c2_uni_partial, i32 8, ptr @c2_Q)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %12 = add i64 %6, 2
  br label %5

13:                                               ; preds = %5
  call void @rope_bundled(ptr @c2_Q, ptr @c2_B0, ptr @c2_Q, i32 256)
  call void @llvm.aie2p.release(i32 53, i32 1)
  call void @llvm.aie2p.release(i32 50, i32 1)
  call void @llvm.aie2p.acquire(i32 61, i32 -1)
...
17:                                               ; preds = %14
  ...
  call void @generic_bcast_gemv_bf16_o(i32 %18, ptr @c2_A0, ptr @c2_B1, ptr @c2_uni_partial, i32 8, ptr @c2_O)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %19 = add i64 %15, 1
  %20 = trunc i64 %19 to i32
  call void @generic_bcast_gemv_bf16_o(i32 %20, ptr @c2_A1, ptr @c2_B1, ptr @c2_uni_partial, i32 8, ptr @c2_O)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %21 = add i64 %15, 2
  br label %14

22:                                               ; preds = %14
  call void @llvm.aie2p.release(i32 60, i32 1)
  call void @llvm.aie2p.release(i32 55, i32 1)
  call void @llvm.aie2p.acquire(i32 63, i32 -1)
  br label %23
...
26:                                               ; preds = %23
  ...
  call void @generic_bcast_gemv_bf16_g(i32 %27, ptr @c2_A0, ptr @c2_B2, ptr @c2_uni_partial, i32 8, ptr @c2_gate)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %28 = add i64 %24, 1
  %29 = trunc i64 %28 to i32
  call void @generic_bcast_gemv_bf16_g(i32 %29, ptr @c2_A1, ptr @c2_B2, ptr @c2_uni_partial, i32 8, ptr @c2_gate)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %30 = add i64 %24, 2
  br label %23
...
34:                                               ; preds = %31
  ...
  call void @generic_bcast_gemv_bf16_g(i32 %35, ptr @c2_A0, ptr @c2_B2, ptr @c2_uni_partial, i32 8, ptr @c2_up)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %36 = add i64 %32, 1
  %37 = trunc i64 %36 to i32
  call void @generic_bcast_gemv_bf16_g(i32 %37, ptr @c2_A1, ptr @c2_B2, ptr @c2_uni_partial, i32 8, ptr @c2_up)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %38 = add i64 %32, 2
  br label %31

39:                                               ; preds = %31
  call void @llvm.aie2p.release(i32 62, i32 1)
  call void @layer_fused_silu_mul_explicit_bf16(ptr @c2_gate, ptr @c2_up, ptr @c2_silu, i32 1024)
...
43:                                               ; preds = %40
  ...
  call void @generic_bcast_gemv_bf16_d(i32 %44, ptr @c2_A0, ptr @c2_silu, ptr @c2_uni_partial, i32 4, ptr @c2_P)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 59, i32 -1)
  %45 = add i64 %41, 1
  %46 = trunc i64 %45 to i32
  call void @generic_bcast_gemv_bf16_d(i32 %46, ptr @c2_A1, ptr @c2_silu, ptr @c2_uni_partial, i32 4, ptr @c2_P)
  call void @llvm.aie2p.release(i32 58, i32 1)
  %47 = add i64 %41, 2
  br label %40
