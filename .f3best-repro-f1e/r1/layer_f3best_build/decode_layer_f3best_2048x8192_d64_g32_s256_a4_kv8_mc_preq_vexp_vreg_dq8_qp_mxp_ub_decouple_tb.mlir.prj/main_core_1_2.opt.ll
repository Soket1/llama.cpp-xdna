; ModuleID = 'decode_layer_f3best_2048x8192_d64_g32_s256_a4_kv8_mc_preq_vexp_vreg_dq8_qp_mxp_ub_decouple_tb.mlir.prj\main_core_1_2.peanohack.ll'
...
declare void @flowkv_score_init_bf16(i32) local_unnamed_addr

declare void @flowkv_score_rope_q_bf16(ptr, i32, i32) local_unnamed_addr

declare void @flowkv_score_chunk_bf16(ptr, ptr, ptr, i32, i32, i32) local_unnamed_addr
...
1:                                                ; preds = %0, %1
  %2 = phi i64 [ 0, %0 ], [ %3, %1 ]
  tail call void @flowkv_score_init_bf16(i32 4)
  tail call void @llvm.aie2p.acquire(i32 49, i32 -1)
  tail call void @flowkv_score_rope_q_bf16(ptr nonnull @sc1_Qs, i32 4, i32 64)
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  tail call void @flowkv_score_chunk_bf16(ptr nonnull @sc1_Qs, ptr nonnull @sc1_K, ptr nonnull @sc1_It, i32 4, i32 64, i32 128)
