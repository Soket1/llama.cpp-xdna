; ModuleID = 'decode_layer_f3best_2048x8192_d64_g32_s256_a4_kv8_mc_preq_vexp_vreg_dq8_qp_mxp_ub_decouple_tb.mlir.prj\main_core_1_4.peanohack.ll'
...
1:                                                ; preds = %0, %1
  ...
  tail call void @flowkv_value_accum_bf16(ptr nonnull @va1_Iv, ptr nonnull @va1_V, i32 4, i32 64, i32 128)
  ...
  tail call void @flowkv_value_normalize_bf16(ptr nonnull @va1_Of, i32 4, i32 64)
