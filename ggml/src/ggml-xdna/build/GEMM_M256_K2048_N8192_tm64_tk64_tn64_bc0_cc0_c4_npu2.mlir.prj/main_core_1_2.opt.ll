; ModuleID = 'GEMM_M256_K2048_N8192_tm64_tk64_tn64_bc0_cc0_c4_npu2.mlir.prj/main_core_1_2.peanohack.ll'
...
9:                                                ; preds = %.lr.ph7, %._crit_edge
  ...
  %11 = load i32, ptr @_anonymous1, align 4
...
.lr.ph:                                           ; preds = %9, %.lr.ph
  ...
  %spec.select5 = select i1 %cond1, ptr @A_L2L1_0_1_cons_buff_1, ptr @A_L2L1_0_1_cons_buff_0
  ...
  %15 = select i1 %cond2, ptr @B_L2L1_1_0_cons_buff_1, ptr @B_L2L1_1_0_cons_buff_0
  tail call void @matmul_bf16_bf16(ptr nonnull %spec.select5, ptr nonnull %15, ptr nonnull %spec.select)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  %16 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous1, i20 4), align 4
  %17 = add i32 %16, 1
  %18 = icmp sgt i32 %17, 1
  %19 = add i32 %16, -1
  %20 = select i1 %18, i32 %19, i32 %17
  store i32 %20, ptr getelementptr inbounds nuw (i8, ptr @_anonymous1, i20 4), align 4
  ...
  store i32 %25, ptr getelementptr inbounds nuw (i8, ptr @_anonymous1, i20 8), align 4
...
._crit_edge:                                      ; preds = %.lr.ph, %9
  ...
  %28 = load i32, ptr @_anonymous1, align 4
  %29 = add i32 %28, 1
  %30 = icmp sgt i32 %29, 1
  %31 = add i32 %28, -1
  %32 = select i1 %30, i32 %31, i32 %29
  store i32 %32, ptr @_anonymous1, align 4
