...
4:                                                ; preds = %1
  ...
  %5 = load i32, ptr @rtp1_1
  %6 = load i32, ptr getelementptr inbounds (i8, ptr @rtp1_1, i64 4)
  %7 = sext i32 %6 to i64
  %8 = sext i32 %5 to i64
  br label %9
...
14:                                               ; preds = %53, %55, %12
  %15 = phi ptr [ %56, %55 ], [ %54, %53 ], [ @C_L1L2_1_1_buff_0, %12 ]
...
23:                                               ; preds = %57, %59, %21
  %24 = phi ptr [ %60, %59 ], [ %58, %57 ], [ @A_L2L1_1_1_cons_buff_0, %21 ]
...
28:                                               ; preds = %61, %63, %26
  %29 = phi ptr [ %64, %63 ], [ %62, %61 ], [ @B_L2L1_1_1_cons_buff_0, %26 ]
...
31:                                               ; preds = %28
  ...
  %32 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous5, i64 4)
  %33 = add i32 %32, 1
  %34 = icmp sge i32 %33, 2
  %35 = add i32 %32, -1
  %36 = select i1 %34, i32 %35, i32 %33
  store i32 %36, ptr getelementptr inbounds (i8, ptr @_anonymous5, i64 4)
  call void @llvm.aie2p.release(i32 51, i32 1)
  %37 = load i32, ptr getelementptr inbounds (i8, ptr @_anonymous5, i64 8)
  %38 = add i32 %37, 1
  %39 = icmp sge i32 %38, 2
  %40 = add i32 %37, -1
  %41 = select i1 %39, i32 %40, i32 %38
  store i32 %41, ptr getelementptr inbounds (i8, ptr @_anonymous5, i64 8)
  %42 = add i64 %19, 1
  br label %18

43:                                               ; preds = %18
  call void @llvm.aie2p.release(i32 54, i32 1)
  %44 = load i32, ptr @_anonymous5
  %45 = add i32 %44, 1
  %46 = icmp sge i32 %45, 2
  %47 = add i32 %44, -1
  %48 = select i1 %46, i32 %47, i32 %45
  store i32 %48, ptr @_anonymous5
  %49 = add i64 %10, 1
  br label %9
...
53:                                               ; preds = %12
  %54 = phi ptr [ @C_L1L2_1_1_buff_0, %12 ]
  br label %14

55:                                               ; preds = %12
  %56 = phi ptr [ @C_L1L2_1_1_buff_1, %12 ]
  br label %14

57:                                               ; preds = %21
  %58 = phi ptr [ @A_L2L1_1_1_cons_buff_0, %21 ]
  br label %23

59:                                               ; preds = %21
  %60 = phi ptr [ @A_L2L1_1_1_cons_buff_1, %21 ]
  br label %23

61:                                               ; preds = %26
  %62 = phi ptr [ @B_L2L1_1_1_cons_buff_0, %26 ]
  br label %28

63:                                               ; preds = %26
  %64 = phi ptr [ @B_L2L1_1_1_cons_buff_1, %26 ]
  br label %28
}
