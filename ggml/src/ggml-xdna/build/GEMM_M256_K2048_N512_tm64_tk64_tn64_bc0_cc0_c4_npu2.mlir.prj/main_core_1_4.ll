...
12:                                               ; preds = %9
  ...
  %13 = load i32, ptr @_anonymous9, align 4
...
14:                                               ; preds = %53, %55, %12
  %15 = phi ptr [ %56, %55 ], [ %54, %53 ], [ @C_L1L2_1_2_buff_0, %12 ]
...
23:                                               ; preds = %57, %59, %21
  %24 = phi ptr [ %60, %59 ], [ %58, %57 ], [ @A_L2L1_2_1_cons_buff_0, %21 ]
  %25 = getelementptr [64 x [64 x bfloat]], ptr %24, i32 0, i32 0, i32 0
  br label %26

26:                                               ; preds = %23
  call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %27 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous9, i64 8), align 4
...
28:                                               ; preds = %61, %63, %26
  %29 = phi ptr [ %64, %63 ], [ %62, %61 ], [ @B_L2L1_1_2_cons_buff_0, %26 ]
...
31:                                               ; preds = %28
  ...
  %37 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous9, i64 8), align 4
  %38 = add i32 %37, 1
  %39 = icmp sge i32 %38, 2
  %40 = add i32 %37, -1
  %41 = select i1 %39, i32 %40, i32 %38
  store i32 %41, ptr getelementptr inbounds nuw (i8, ptr @_anonymous9, i64 8), align 4
  %42 = add i64 %19, 1
  br label %18
...
43:                                               ; preds = %18
  ...
  store i32 %48, ptr @_anonymous9, align 4
  %49 = add i64 %10, 1
  br label %9
...
53:                                               ; preds = %12
  %54 = phi ptr [ @C_L1L2_1_2_buff_0, %12 ]
  br label %14

55:                                               ; preds = %12
  %56 = phi ptr [ @C_L1L2_1_2_buff_1, %12 ]
  br label %14

57:                                               ; preds = %21
  %58 = phi ptr [ @A_L2L1_2_1_cons_buff_0, %21 ]
  br label %23

59:                                               ; preds = %21
  %60 = phi ptr [ @A_L2L1_2_1_cons_buff_1, %21 ]
  br label %23

61:                                               ; preds = %26
  %62 = phi ptr [ @B_L2L1_1_2_cons_buff_0, %26 ]
  br label %28

63:                                               ; preds = %26
  %64 = phi ptr [ @B_L2L1_1_2_cons_buff_1, %26 ]
  br label %28
}
