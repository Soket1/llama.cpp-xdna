module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<524288xbf16>, %arg1: memref<1048576xbf16>, %arg2: memref<131072xbf16>) {
      ...
      %1 = aiex.dma_configure_task_for @A_L3L2_0_shim_alloc {
        aie.dma_bd(%arg0 : memref<524288xbf16>, 0, 131072, [<size = 2, stride = 0>, <size = 32, stride = 64>, <size = 64, stride = 2048>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @B_L3L2_0_shim_alloc {
        aie.dma_bd(%arg1 : memref<1048576xbf16>, 0, 131072, [<size = 2, stride = 256>, <size = 32, stride = 32768>, <size = 64, stride = 512>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %4 = aiex.dma_configure_task_for @A_L3L2_1_shim_alloc {
        aie.dma_bd(%arg0 : memref<524288xbf16>, 131072, 131072, [<size = 2, stride = 0>, <size = 32, stride = 64>, <size = 64, stride = 2048>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @B_L3L2_1_shim_alloc {
        aie.dma_bd(%arg1 : memref<1048576xbf16>, 64, 131072, [<size = 2, stride = 256>, <size = 32, stride = 32768>, <size = 64, stride = 512>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %7 = aiex.dma_configure_task_for @A_L3L2_2_shim_alloc {
        aie.dma_bd(%arg0 : memref<524288xbf16>, 262144, 131072, [<size = 2, stride = 0>, <size = 32, stride = 64>, <size = 64, stride = 2048>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%7)
      %8 = aiex.dma_configure_task_for @B_L3L2_2_shim_alloc {
        aie.dma_bd(%arg1 : memref<1048576xbf16>, 128, 131072, [<size = 2, stride = 256>, <size = 32, stride = 32768>, <size = 64, stride = 512>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      ...
      %10 = aiex.dma_configure_task_for @A_L3L2_3_shim_alloc {
        aie.dma_bd(%arg0 : memref<524288xbf16>, 393216, 131072, [<size = 2, stride = 0>, <size = 32, stride = 64>, <size = 64, stride = 2048>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
      aiex.dma_start_task(%10)
      %11 = aiex.dma_configure_task_for @B_L3L2_3_shim_alloc {
        aie.dma_bd(%arg1 : memref<1048576xbf16>, 192, 131072, [<size = 2, stride = 256>, <size = 32, stride = 32768>, <size = 64, stride = 512>, <size = 64, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {repeat_count = 1 : i32}
