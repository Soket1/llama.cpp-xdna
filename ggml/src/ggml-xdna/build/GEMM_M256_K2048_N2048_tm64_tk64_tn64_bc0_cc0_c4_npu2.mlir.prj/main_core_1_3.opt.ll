; ModuleID = 'GEMM_M256_K2048_N2048_tm64_tk64_tn64_bc0_cc0_c4_npu2.mlir.prj/main_core_1_3.peanohack.ll'
...
@rtp1_1 = local_unnamed_addr global [2 x i32] zeroinitializer
...
1:                                                ; preds = %0, %._crit_edge6
  ...
  %3 = load i32, ptr @rtp1_1, align 4
  %4 = load i32, ptr getelementptr inbounds nuw (i8, ptr @rtp1_1, i20 4), align 4
  %5 = sext i32 %4 to i64
  %6 = sext i32 %3 to i64
  %7 = icmp sgt i32 %4, 0
...
9:                                                ; preds = %.lr.ph5, %._crit_edge
  ...
  tail call void @zero_f32(ptr nonnull @acc_buffer_1_1)
  br i1 %8, label %.lr.ph, label %._crit_edge

.lr.ph:                                           ; preds = %9, %.lr.ph
  %11 = phi i64 [ %25, %.lr.ph ], [ 0, %9 ]
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %12 = load i32, ptr @_anonymous5, align 4
  %cond = icmp eq i32 %12, 1
  %spec.select = select i1 %cond, ptr @A_L2L1_1_1_cons_buff_1, ptr @A_L2L1_1_1_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %13 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous5, i20 4), align 4
  %cond1 = icmp eq i32 %13, 1
  %14 = select i1 %cond1, ptr @B_L2L1_1_1_cons_buff_1, ptr @B_L2L1_1_1_cons_buff_0
  tail call void @matmul_bf16_f32(ptr nonnull %spec.select, ptr nonnull %14, ptr nonnull @acc_buffer_1_1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  %15 = load i32, ptr @_anonymous5, align 4
  %16 = add i32 %15, 1
  %17 = icmp sgt i32 %16, 1
  %18 = add i32 %15, -1
  %19 = select i1 %17, i32 %18, i32 %16
  store i32 %19, ptr @_anonymous5, align 4
...
._crit_edge:                                      ; preds = %.lr.ph, %9
  ...
  tail call void @convert_copy_f32_to_bf16(ptr nonnull @acc_buffer_1_1, ptr nonnull @C_L1L2_1_1_buff_0, i32 4096)
  ...
  %30 = add i32 %27, %29
  store i32 %30, ptr getelementptr inbounds nuw (i8, ptr @_anonymous5, i20 8), align 4
